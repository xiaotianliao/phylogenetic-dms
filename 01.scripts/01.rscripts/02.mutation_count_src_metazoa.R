...
# Usage
input_file <- '/Users/xl7/Documents/0.Projects/02.phylo-dms/00.inputs/src_metazoa_asr_lgg4/src_metazoa_asr_lgg4.state'
sequences <- extract_sequences(input_file)
head(sequences)

output_file <- '/Users/xl7/Documents/0.Projects/02.phylo-dms/00.inputs/src_metazoa_asr_lgg4/src_metazoa_asr_lgg4_reconstructed_sequences.fasta'
save_sequences(sequences, output_file)


#######################################################################################
# Read the FASTA file
fasta_file <- '/Users/xl7/Documents/0.Projects/02.phylo-dms/00.inputs/src_metazoa_asr_lgg4/src_metazoa_asr_lgg4_mafft_auto_web.fasta'
...
output_file <- "/Users/xl7/Documents/0.Projects/02.phylo-dms/02.outputs/src_metazoa_asr_lgg4_sequence_comparisons.csv"
...
#######################################################################################
# Read the CSV file
data <- read.csv("/Users/xl7/Documents/0.Projects/02.phylo-dms/02.outputs/src_metazoa_asr_lgg4_sequence_comparisons.csv")
...
write.csv(filtered_data %>% select(transition, mutations, mutation_count), "/Users/xl7/Documents/0.Projects/02.phylo-dms/02.outputs/src_metazoa_asr_lgg4_filtered_sequence_comparisons.csv", row.names = FALSE)
