...
# Usage
input_file <- '/Users/xl7/Documents/0.Projects/02.phylo-dms/00.inputs/00.src/foldmason_src_homo_primate_asr/foldmason_src_homo_primate_asr.state'
sequences <- extract_sequences(input_file)
head(sequences)

output_file <- '/Users/xl7/Documents/0.Projects/02.phylo-dms/00.inputs/00.src/foldmason_src_homo_primate_asr/foldmason_reconstructed_src_homo_primate_asr.fasta'
