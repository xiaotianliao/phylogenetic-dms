...
# Usage
input_file <- '/Users/xl7/Documents/0.Projects/02.phylo-dms/00.inputs/src_eutheria_asr/src_eutheria_asr.state'
sequences <- extract_sequences(input_file)
head(sequences)

output_file <- '/Users/xl7/Documents/0.Projects/02.phylo-dms/00.inputs/src_eutheria_asr/src_eutheria_reconstructed_sequences.fasta'
save_sequences(sequences, output_file)


#######################################################################################
# Read the FASTA file
fasta_file <- "/Users/xl7/Documents/0.Projects/02.phylo-dms/00.inputs/src_eutheria_asr/src_eutheria_mafft_einsi_web.fasta"
...
output_file <- "/Users/xl7/Documents/0.Projects/02.phylo-dms/02.outputs/src_eutheria_sequence_comparisons.csv"
...
#######################################################################################
# Read the CSV file
data <- read.csv("/Users/xl7/Documents/0.Projects/02.phylo-dms/02.outputs/src_eutheria_sequence_comparisons.csv")
...
write.csv(filtered_data %>% select(transition, mutations, mutation_count), "/Users/xl7/Documents/0.Projects/02.phylo-dms/02.outputs/src_eutheria_filtered_sequence_comparisons.csv", row.names = FALSE)
